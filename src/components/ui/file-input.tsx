...
export default function FileInput({
  ...
  multiple,
  accept,
  onFilesChanged, // Add this prop
}: {
  className?: string;
  label?: React.ReactNode;
  multiple?: boolean;
  accept?: any;
  onFilesChanged?: (files: Array<File>) => void; // Add this line
}) {
  ...
  const handleMultiImageUpload = (
    ...
    const updatedFiles = [...multiImages, ...newFiles];
    setMultiImages(updatedFiles);
    if (onFilesChanged) onFilesChanged(updatedFiles); // Call the callback with the updated files
  };
