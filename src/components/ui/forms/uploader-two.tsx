...
function Upload(
  ...
  return (
    <div
      className={cn(
        'rounded-lg border border-solid border-gray-200 bg-white p-2 dark:border-gray-700 dark:bg-light-dark sm:p-6',
        wrapperClassName,
      )}
    >
      <div
        className="border border-dashed relative border-gray-200 dark:border-gray-700 h-24 flex items-center justify-center rounded-lg"
        {...dropzoneRootProps}
      >
        <input
          ref={ref}
